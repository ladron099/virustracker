        ...
        child: Column(
          ...
          children: [
           ...
           if (submit == true && name.text == "")
            ...
            if (submit == true && cin.text == "")
              errorMessage("Veuillez entrer un cin valide."),
            Padding(
                padding: EdgeInsets.fromLTRB(h*0.035, h*0.015, h*0.035, 0),
                ...
                child: submitButton(
                  ...
                  press: () async {
                   final ConnectivityResult result = await Connectivity().checkConnectivity();
                      ...
                      submit = true;
                        bool found = name.text.contains(new RegExp(r'[0-9]'));
                      if (name.text != "" && dateCtl.text != ""&& found==false)
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => registerSecondStep(
                                    name.text, age, newValue,birth, cin.text)));

else if(found==true && cin.text!=''){
        Fluttertoast.showToast(
          msg: 'Veuillez entrez un nom valide.',
